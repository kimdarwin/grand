...
for l in jsons:
    ...
    try:
        ...
        query_doc = dictionary.doc2bow(okttokenizer(question+keys))
        
        print("QUERY: "+str(okttokenizer(question+keys)))
        ...
        best_docs = sorted(range(len(scores)), key=lambda i: scores[i])[-50:]
